...
import GuestUploader from "@/features/guest-review/components/GuestUploader";
...
interface ToolLandingPagePTProps {
  headline: string;
  description: string;
  badge?: string;
  faq: FAQ[];
...
const RELATED_TOOLS = [
  { label: "Aprovar design com cliente", href: "/pt/aprovar-design-cliente" },
  { label: "Revisão de design online", href: "/pt/revisao-design-online" },
  { label: "Feedback de site", href: "/pt/feedback-site" },
  { label: "Enviar layout para cliente", href: "/pt/enviar-layout-cliente" },
  { label: "Revisão de UI", href: "/pt/revisao-ui" },
  {
    label: "Ferramenta de aprovação",
    href: "/pt/ferramenta-aprovacao-cliente",
  },
  { label: "Revisar mockup", href: "/pt/revisar-mockup" },
  { label: "Revisão de design e UI", href: "/pt/revisao-design-ui" },
  { label: "Feedback de design", href: "/pt/feedback-design" },
  { label: "Aprovação de layout", href: "/pt/aprovacao-layout" },
];

export default function ToolLandingPagePT({
  headline,
  description,
  badge = "Gratuito · Sem cadastro",
  faq,
}: ToolLandingPagePTProps) {
  return (
        ...
        <div className="flex flex-col gap-7 order-2 lg:order-1">
          ...
          <div className="flex flex-col gap-4 pt-2">
            {[
              {
                n: "1",
                title: "Envie seu design",
                sub: "Imagens, PDFs, vídeos — até 20 MB",
              },
              {
                n: "2",
                title: "Gere um link de revisão na hora",
                sub: "Sem cadastro. Compartilhe em segundos.",
              },
              {
                n: "3",
                title: "Seu cliente revisa e decide",
                sub: "Aprovar, solicitar mudanças ou deixar comentários fixos",
              },
            ].map((step) => (
        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <p className="text-[11px] text-white/20">
              © {new Date().getFullYear()} ApproveFlow · Ferramenta gratuita de
              aprovação para freelancers e agências
            </p>
            <a
              href="/login"
